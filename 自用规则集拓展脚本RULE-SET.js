...
const main = (config) => {
  ...
  config["bind-address"] = "0.0.0.0"; // 修正为有效IP
  config["ipv6"] = true;
...
const proxyGroupConfig = [
  ...
  },
  {
    ...
    "name": "🍎 Apple",
    "type": "select",
    "proxies": ["🎯 DIRECT", "🌍 Proxy", "🚫 REJECT", "🇭🇰 香港总汇", "🇹🇼 台湾总汇", "🇯🇵 日本总汇", "🇰🇷 韩国总汇", "🇺🇸 美国总汇", "🇩🇪 德国总汇", "🇸🇬 新加坡总汇", "🇫🇷 法国总汇", "🇬🇧 英国总汇", "🌐 其他总汇"],
    "include-all": true,
  ...
  },
  {
    ...
    "name": "📱 Telegram",
    "type": "select",
    "proxies": ["🌍 Proxy", "🎯 DIRECT", "🚫 REJECT", "🇭🇰 香港总汇", "🇹🇼 台湾总汇", "🇯🇵 日本总汇", "🇰🇷 韩国总汇", "🇺🇸 美国总汇", "🇩🇪 德国总汇", "🇸🇬 新加坡总汇", "🇫🇷 法国总汇", "🇬🇧 英国总汇", "🌐 其他总汇"],
    "include-all": true,
    "exclude-filter": "(?i)GB|Traffic|Expire|Premium|频道|订阅|ISP|流量|到期|重置",
